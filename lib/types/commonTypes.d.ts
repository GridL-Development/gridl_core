/** @format */
import { Account, AccountAttribute, AccountAttributeAndValue, AccountAttributeValue, AccountType, AccountTypeTag, Client, Country, Currency, CurrencyIsoCode, DataSource, DataSourceCredential, DataSourceLoader, DataSourceTask, Dimension, DimensionValue, DimensionValueAttribute, DimensionValueAttributeAndValue, DimensionValueAttributeValue, Instance, Level, LevelAttribute, LevelAttributeAndValue, LevelAttributeValue, User, Version, CubeAccountStructure, CubeLevelStructure } from "../prisma/generated/client";
...
export interface CurrencyWithOptionalParts extends Pick<Currency, "code" | "currencyIsoCodeId" | "name" | "isDefault"> {
}
...
export interface DimensionValueAttributeValueExtended extends DimensionValueAttributeValue {
...
export interface ExportAccount extends Pick<Account, "code" | "name" | "containsSalaryInfo" | "actualsBy" | "plannedBy" | "displayAs" | "description"> {
    parent: Pick<Account, "code"> | null;
}
export interface ExportAccountAttribute extends Pick<AccountAttribute, "code" | "name" | "description"> {
}
...
export interface ExportDimension extends Pick<Dimension, "code" | "name" | "description"> {
}
...
export interface ExportDimensionValueAttribute extends Pick<DimensionValueAttribute, "code" | "name" | "description"> {
}
export interface ExportLevel extends Pick<Level, "code" | "name" | "description"> {
    parent: string | null;
    currency: string;
}
export interface ExportLevelAttribute extends Pick<LevelAttribute, "code" | "name" | "description"> {
}
...
export interface ExportVersion extends Pick<Version, "code" | "name" | "begin" | "end" | "status" | "startOfPlan" | "description"> {
}
...
export interface LevelWithCurrencyParentChildLevelsAttributesAndValues extends Level {
    currency?: Currency;
    parent?: Level | null;
    childLevels?: Level[];
    AttributeAndValues?: LevelAttributeAndValue[];
}
export interface LevelAttributeValueWithPathAndParent extends LevelAttributeValue {
    path: string[];
...
export interface CubeAccountStructureWithCodeAndName extends CubeAccountStructure {
    code: string;
    name: string;
    accountTypeTag: AccountTypeTag;
}
