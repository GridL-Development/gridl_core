/** @format */
import { Account, AccountAttribute, AccountAttributeValue, Client, Cube, Currency, CurrencyIsoCode, DataSource, DataSourceCredential, DataSourceLoader, DataSourceTask, Dimension, DimensionValue, DimensionValueAttribute, DimensionValueAttributeValue, Instance, Level, LevelAttribute, LevelAttributeValue, Table, User, UserLog, Version } from "../prisma/generated/client";
import { AccountAttributeValueWithPath, AccountWithAttributesAndValues, AccountWithPathAndParent, ClientWithCountry, CurrencyWithCurrencyIsoCode, CurrencyWithOptionalParts, DataSourceLoaderMappingTable, DimensionValueAttributeValueExtended, DimensionValueExtended, DimensionValueWithAttributesAndValues, ExportAccount, ExportAccountAttribute, ExportDimension, ExportDimensionValueAttribute, ExportLevel, ExportLevelAttribute, ExportVersion, InstanceWithClient, LevelAttributeValueWithPath, LevelAttributeValueWithPathAndParent, LevelWithCurrencyParentChildLevelsAttributesAndValues, LevelWithCurrencyPathAndParent, LoaderColumnMappingType, Grid, SourceTableColumnProperty, TreeSelectDataNode, UserExtended, ValueLabelType, ValueLabelTypeWithChildren, CubeAccountStructureWithAccount, ExportDimensionValue, ExportAccountAttributeValue, ExportLevelAttributeValue, CubeLevelStructureWithLevel } from "./commonTypes";
...
export interface APIResponseAccountAttributeValueWithPath extends APIResponseType {
    data: AccountAttributeValueWithPath[];
}
export interface APIResponseAccountWithAttributesAndValues extends APIResponseType {
    data: AccountWithAttributesAndValues;
}
export interface APIResponseAccountWithAttributesAndValuesArray extends APIResponseType {
    data: AccountWithAttributesAndValues[];
}
...
export interface APIResponseCurrencyWithCurrencyIsoCode extends APIResponseType {
    data: CurrencyWithCurrencyIsoCode;
}
export interface APIResponseCurrencyWithCurrencyIsoCodeArray extends APIResponseType {
    data: CurrencyWithCurrencyIsoCode[];
}
...
export interface APIResponseDataSourceLoaderMappingTable extends APIResponseType {
...
export interface APIResponseDimensionValueAttributeValue extends APIResponseType {
    data: DimensionValueAttributeValue;
}
export interface APIResponseDimensionValueAttributeArray extends APIResponseType {
    data: DimensionValueAttribute[];
}
export interface APIResponseDimensionValueAttributeValueExtended extends APIResponseType {
    data: DimensionValueAttributeValueExtended;
}
export interface APIResponseDimensionValueAttributeValueExtendedArray extends APIResponseType {
    data: DimensionValueAttributeValueExtended[];
}
export interface APIResponseDimensionValueWithAttributesAndValues extends APIResponseType {
...
export interface APIResponseDimensionValueExtendedArray extends APIResponseType {
    data: DimensionValueExtended[];
}
...
export interface APIResponseExportAccountAttributeArray extends APIResponseType {
    data: ExportAccountAttribute[];
}
export interface APIResponseExportAccountAttributeValue extends APIResponseType {
    data: ExportAccountAttributeValue;
}
export interface APIResponseExportAccountAttributeValueArray extends APIResponseType {
    data: ExportAccountAttributeValue[];
}
...
export interface APIResponseExportDimensionValueAttribute extends APIResponseType {
    data: ExportDimensionValueAttribute;
}
export interface APIResponseExportDimensionValueAttributeArray extends APIResponseType {
    data: ExportDimensionValueAttribute[];
}
...
export interface APIResponseExportLevelAttributeValueArray extends APIResponseType {
    data: ExportLevelAttributeValue[];
}
...
export interface APIResponseLevelAttributeValueWithPath extends APIResponseType {
    data: LevelAttributeValueWithPath[];
}
export interface APIResponseLevelAttributeValueWithPathAndParent extends APIResponseType {
    data: LevelAttributeValueWithPathAndParent[];
}
export interface APIResponseLevelWithCurrencyPathAndParent extends APIResponseType {
    data: LevelWithCurrencyPathAndParent;
}
export interface APIResponseLevelWithCurrencyPathAndParentArray extends APIResponseType {
    data: LevelWithCurrencyPathAndParent[];
}
export interface APIResponseLevelWithCurrencyParentChildLevelsAttributesAndValues extends APIResponseType {
...
export interface APIResponseCubeAccountStructureWithAccount extends APIResponseType {
    data: CubeAccountStructureWithAccount;
}
export interface APIResponseCubeAccountStructureWithAccountArray extends APIResponseType {
    data: CubeAccountStructureWithAccount[];
}
export interface APIResponseCubeArray extends APIResponseType {
    data: Cube[];
}
export interface APIResponseCubeLevelStructureWithLevel extends APIResponseType {
    data: CubeLevelStructureWithLevel;
}
export interface APIResponseCubeLevelStructureWithLevelArray extends APIResponseType {
    data: {
...
export interface APIResponseSourceTableColumnPropertyArray extends APIResponseType {
...
export interface APIResponseValueLabelTypeWithChildrenArray extends APIResponseType {
